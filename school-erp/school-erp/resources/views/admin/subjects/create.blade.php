...
@section('page-title', 'নতুন বিষয়')
@section('content')
<form method="POST" action="{{ route('admin.subjects.store') }}" class="bg-white rounded shadow p-6 max-w-lg space-y-4">
    @csrf
    <div>
    ...
    <div>
        <label class="block text-sm font-medium mb-1">কোড (ঐচ্ছিক)</label>
